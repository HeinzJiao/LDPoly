...
Example:
    PYTHONPATH=./:$PYTHONPATH python -u scripts/polygonization_refined.py --annotation_path ./data/deventer_road/annotations/test.json \
                             --outputs_dir ./outputs/deventer_road_reproduction/epoch=824-step=739199 \
                             --sampler ddim \
                             --output_vertices_file "output_vertices_from_heatmap_x4_ddim_th-0.1_k-3" \
                             --save_file "polygons_seg_ddim_vertices_from_scaled4_heat_th-0.1_k-3.0_3.2_dp_eps2.json" \
