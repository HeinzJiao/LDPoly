...
if __name__ == '__main__':
    main()
    """
    PYTHONPATH=./:$PYTHONPATH python -u scripts/split_to_patches.py -i ./data/vaihingen_map_generalization/test/Test_1_and_2_for_15k/FTest1_input.png \
        -o ./data/vaihingen_map_generalization/test/Test_1_and_2_for_15k/FTest1_input \
        -p 128
    """